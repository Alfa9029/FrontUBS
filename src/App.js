      ...
      <div className="flex flex-col min-h-screen">
        ...
        <main className="flex-grow bg-white w-full">
          <Routes>
            ...
            <Route path="/listar" element={<PrivateRoute element={ListaProf} />} />
            <Route path="/calendario" element={<PrivateRoute element={Calendario} />} />
            <Route path="/createCampaign" element={<PrivateRoute element={CreateCampaign} />} />
            <Route path="/createProfessional" element={<PrivateRoute element={CreateProfessional} />} />
          </Routes>
        </main>
        <Footer />
      </div>
